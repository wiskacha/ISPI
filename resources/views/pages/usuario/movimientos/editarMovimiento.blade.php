    ...
    <div id="content-to-pdf" class="content content-boxed">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="ms-3">
                    <a href="{{ route('usuario.previewRecibo', $movimiento->id_movimiento) }}" target="_blank">
                ...
                <div class="ms-3">
                    <a href="{{ route('usuario.downloadRecibo', $movimiento->id_movimiento) }}" target="_blank">
            ...
            <div class="block-content">
                <form id="movimiento-edit" action="{{ route('usuario.updateMv', $movimiento->id_movimiento) }}"
                        ...
                        <div class="ms-3">
                            ...
                            <script>
                                document.getElementById('editarDetallesBtn').addEventListener('click', function() {
                                    ...
                                    // Llamada AJAX
                                    fetch(`/usuario/movimientos/${movimientoId}/check-cuotas`)
                                        ...
                                        .then(data => {
                                            if (data.exists) {
                                                ...
                                                window.location.href = `/usuario/movimientos/${movimientoId}/editDetalles`;
                                            }
                                        })
                                        .catch(error => {
                        ...
                        @else
                            <div class="row justify-content-center py-sm-3 py-md-5">
                                <div class="col-sm-10 col-md-8">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <form
                                            action="{{ route('usuario.asignarCuotas', $movimiento->id_movimiento) }}"
                                            method="GET">
                                            @csrf
