        ...
        <div class="block-content block-content-full">
            ...
            <div class="step-container" id="step-2">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="tipo" name="tipo" value="SALIDA" readonly>
                </div>
                <div class="col-12 col-lg-6 ms-auto d-flex justify-content-end">
            ...
            <div class="step-container" id="step-5">
                ...
                <form id="hidden-form" action="{{ route('usuario.storeMv') }}" method="POST" style="display: none;">
                    @csrf
    ...
    <script>
        ...
        function validateProductAvailability() {
            ...
            for (const productName in productQuantities) {
                ...
                $.ajax({
                    url: '/usuario/movimientos/check-product-availability', // Define your endpoint here
                    method: 'POST',
                    data: {
                        almacene: almaceneId,
